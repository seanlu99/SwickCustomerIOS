...
//  Swick
//
//  Taken from https://gist.github.com/Amzd/2eb5b941865e8c5cccf149e6e07c8810
//
...
fileprivate struct TabBarController: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UITabBarControllerDelegate {
        ...
        func tabBarController(_ tabBarController: UITabBarController, shouldSelect viewController: UIViewController) -> Bool {
            // If view to show is Scan and current view is Scan, don't do anything
            return !(viewController == parent.controllers[1] && parent.controllers[1] == parent.controllers[parent.selectedIndex])
            }
        #endif
